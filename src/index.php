...
$manager = new \App\Manager\CommentManager($database_connection->connection);
//$manager->createPost(["title"=>"coucou", "content"=> "conbnbnbucou", "thumbnail_url" => "https://source.unsplash.com/random", "author_id"=>"1", "publication_date"=>"2001-10-14 14:00:00", "id"=> "10"]);
...
//$manager->create(["author_id"=>"1", "post_id"=>"2", "content"=>"testeteszerkl"]);
